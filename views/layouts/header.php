...
<header class="main-header ">
    <?= Html::a('<span class="logo-mini"><b><img src="../../images/logorfl_min.png" class="img-circle" alt="RFL" style="width:65%;"></b></span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
